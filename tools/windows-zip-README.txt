QtSpim-Edu @VERSION@ for Windows   (based on QtSpim @BASE_VERSION@)
=====================================================================

  Run QtSpimEdu.exe.  Nothing is installed; delete this folder to remove it.
...
QtSpim-Edu @VERSION@ (Windows)   한국어
=====================================================================

  QtSpimEdu.exe를 실행하세요.  설치 과정은 없고, 지우려면 이 폴더를 삭제하면
...
--------
  ...
  licence (README-SPIM.txt).  QtSpim-Edu is an unofficial modification, not
  affiliated with or endorsed by the SPIM project.  The Qt libraries in this
  folder are distributed under the GNU LGPL v3 / v2.1
