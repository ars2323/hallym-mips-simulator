...
zip과 MSI는 릴리스 v1.0.4의 자산을 쓴다.

## 1. 설치와 실행

- [ ] `HallymMIPS-1.0.4-win64.zip`을 풀고 `HallymMIPS.exe` 실행. 관리자 권한 없이 뜬다.
- [ ] `HallymMIPS-1.0.4-win64.msi` 설치 → 시작 메뉴에 "Hallym MIPS Simulator".
- [ ] 1.0.3이 설치된 PC에서 1.0.4 MSI가 **덮어쓰기(업그레이드)** 된다. 항목이 두 개 남지 않는다.
