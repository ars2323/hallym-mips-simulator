/* Hallym MIPS Simulator -- where the tour's card goes.
   ...
   be clicked, and the tour is then stuck -- this is what went wrong on
...
// overlay: the whole area the card may use (the tour's overlay, at 0,0).
